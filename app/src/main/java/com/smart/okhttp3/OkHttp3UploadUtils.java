...
public class OkHttp3UploadUtils {
     ...
     */
    public static void doPostUploadRequest(String url, List<String> fileNames, Callback callback) {
     ...
     * @param callback  OkHttp的回调接口
     */
    public static void doPostUploadRequest(String url, HashMap<String, String> map, List<String> fileNames, Callback callback) {
